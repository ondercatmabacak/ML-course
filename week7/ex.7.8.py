...
# -*- coding: utf-8 -*-
"""
Created on Thu Jun 20 17:00:10 2019
...
def estimate_n_clusters(data, n_cluster_set, criteria="bic"):
    ...
    for n_clusters in n_cluster_set:
        ...
        gmm = GaussianMixture(n_components=n_clusters, covariance_type="full", 
                              n_init=100, max_iter=1000, random_state=22)
...
def test_model(data, n_clusters, criteria="bic"):
    ...
    cluster_covs = model.covariances_
    ...
    disp_cluster_ellipses(cluster_means, cluster_covs, cov_type="full")
    plot_boundary(model)
...
test_model(data, n_clusters=range(2, 6), criteria="aic")
test_model(data, n_clusters=range(2, 6), criteria="bic")
...
# test model (estimate number of clusters)
test_model(data, n_clusters=range(2, 10), criteria="bic")
test_model(data, n_clusters=range(2, 10), criteria="aic")
