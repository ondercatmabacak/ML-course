...
# -*- coding: utf-8 -*-
"""
Created on Thu Jun 20 10:16:19 2019

@author: ayf

Examining model hyper-parameters (n_components)
"""
...
#%% Examine GMM hyper parameter: n_clusters

# model hyper-parameters (values are up to you)
cov_type="full"
n_clusterss = range(2, 10) 
...
for n_clusters in n_clusterss:
    ...
    # create the model 
    gmm = GaussianMixture(n_components=n_clusters, covariance_type=cov_type, random_state=22)
