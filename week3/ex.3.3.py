...
Understanding effects of hyper-parameters on model (binary intermixed dataset)
"""
...
closeAll()
criterion = "entropy"
max_depth_values = xrange(1, 11) # various max_depth values (a sequence from 1 to 10)
